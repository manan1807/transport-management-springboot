...
<%@ page
	import="java.util.HashMap, com.gl.trans.model.Route, com.gl.trans.model.*, java.util.*"
	import="java.util.HashMap, com.gl.trans.model.RouteDetail, com.gl.trans.model.*, java.util.*"%>
			...
			<div class="navbar-header" style="background-color: darkseagreen">
				...
				<ul class="nav navbar-top-links navbar-right pull-right">
					...
					<li><a class="profile-pic" href="#"> <img
							...
							class="img-circle"><b class="hidden-xs">Employee</b></a></li>
				</ul>
			</div>
			<!-- /.navbar-header -->
			<!-- /.navbar-top-links -->
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav slimscrollsidebar">
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="profile.html" class="waves-effect">View Route
							Chart</a>
					<li><a href="profile.html" class="waves-effect">Request A
							Cab </a></li>
					<li><a href="basic-table.html" class="waves-effect">View
							Line Manager</a></li>
			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Hello, Employee_Name</h4>
					</div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"
						style="padding-left: 595px;">
				...
				<%
					HashMap<Route, List<RouteDetail>> map = (HashMap<Route,List<RouteDetail>>)request.getAttribute("route");
					int nroutes = map.keySet().size();
					Set<Route> routeSet = map.keySet();
					Iterator<Route> iter = routeSet.iterator();
					for (int i = 0; i < nroutes; i++) {
						Route key = (Route) iter.next();
				%>

				<div id="accordion">
					<div class="card"
						style="border-left: solid #00bfff 3px; background-color: #b3f0ff;">
						<div class="card-header" id="heading<%=i + 1%>"></div>
						<h5 class="mb-0">
						...
						<div class="card-body">
							<table class="table table-borderless">
								...
								<tbody>
									<tr>
										...
										<td><textarea readonly rows="1" cols="25"
												style="border: none; background-color: beige; font-weight: bold;"><%=key.getCabdriver().getVehicle().getVehicleNumber()%></textarea></td>
										<td><textarea readonly rows="1" cols="25"
												style="border: none; background-color: beige; font-weight: bold;"><%=key.getCabdriver().getDriver().getName()%></textarea></td>
										<td><textarea readonly rows="1" cols="25"
												style="border: none; background-color: beige; font-weight: bold;"><%=key.getCabdriver().getDriver().getPhoneNumber()%></textarea></td>
									</tr>
							...
							<table class="table table-borderless">
								...
								<tbody>
									...
									<%
										List<RouteDetail> listRd = map.get(key);
											int curRDidToAck = 0;
											int j=0;
											for (RouteDetail rd : listRd) {
												Employee curEmp = (Employee) session.getAttribute("employee");
												if (rd.getEmployee().getEmployeeId() == curEmp.getEmployeeId())
													curRDidToAck = rd.getRouteDetailId();
												j++;
												
									%>
									<tr>
										<th scope="row"><%=j%></th>
										<td><%=rd.getEmployee().getName()%></td>
							...
							<form action="/ack" method="post">
								<input type="hidden" name="RouteDetailId"
									value="<%=curRDidToAck%>" />
									
									<input type="hidden" value="YES"/> <input
									class="btn btn-success btn btn-primary btn-lg btn-block"
									type="submit" name="ack" value="ACKNOWLEDGMENT" />
							</form>
...
<footer class="footer text-center"> 2019 &copy;
	guardianindia.com </footer>
</html>
