				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							...
							<form action="/addCabDriverToDatabase" method="post"
								enctype="multipart/form-data">
								<fieldset>
									<legend>Add Cab&Driver Details</legend>
									<label for="file">Choose file to upload</label><br> <input
										type="file" id="file" name="uploadedFile" accept=".csv"><br>
									<br> <input type="submit" class="like" value="Upload"
										id="Uploadbutton"> <input type="reset"
										id="ResetButton" class="like" value="Reset">
								</fieldset>
							</form>
